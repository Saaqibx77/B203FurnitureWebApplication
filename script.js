...
const products = [
  { id: 1, name: "Oak Lounge Sofa",      price: 189.00, emoji: "🛋️" },
  { id: 2, name: "Walnut Dining Table",   price: 129.00, emoji: "🪑" },
  { id: 3, name: "Teak Bookshelf",        price: 84.00,  emoji: "📚" },
  { id: 4, name: "Maple Office Desk",     price: 142.00, emoji: "🖥️" },
  { id: 5, name: "Pine Bedside Table",    price: 47.50,  emoji: "🛏️" },
  { id: 6, name: "Cedar Wardrobe",        price: 220.00, emoji: "🚪" },
  { id: 7, name: "Bamboo Accent Chair",   price: 63.00,  emoji: "💺" },
  { id: 8, name: "Rosewood Coffee Table", price: 98.00,  emoji: "☕" },
];
...
function placeOrder(e) {
  ...
  const orderNum = "LW-" + Date.now().toString(36).toUpperCase();
